...
var videoDownInfo =new Array(); //缓存每个节点的下载状态，一个节点一个id
...
function getdownrecord(){
    ...
    alert(JSON.stringify(saverecordObj))

        var saverecordObj ={"readTime":1483203661,"data":[{"state":2,"progress":10,"path":"a//b//c//d//ed//fd"},{"state":1,"progress":20,"path":"aa//b//c4"},{"state":2,"progress":50,"path":"a3//b1//c2"}]}
...
function initDomDownStatus(){
    ...
    for (j=1; j<pathlen;j++ ){
        ...
        //
        $("#"+domid).html( domid +","+domprogress+","+domstatus+","+domtasknum);
        //------------------设置结束--------------------------
        // console.log(strs[j]);
        // console.log(domInfo);
    }
